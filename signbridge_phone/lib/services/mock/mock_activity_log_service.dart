...
/// In-memory mock [ActivityLogService].
///
/// Entries are stored in a list (newest first) and are not persisted between
/// sessions. The live [logStream] broadcasts each new entry immediately.
